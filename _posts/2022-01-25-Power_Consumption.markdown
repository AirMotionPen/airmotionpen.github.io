...
| -------------                            |:-------------:| -----:|
| MPU Sensor for Pen-Tip Localization: // MPU-6500 [Link](https://www.amazon.ca/gp/product/B07P5YZ7ZD/ref=ppx_yo_dt_b_asin_title_o05_s00?ie=UTF8&psc=1)| right-aligned | $1600 |
| -------------                            |:-------------:| -----:|
